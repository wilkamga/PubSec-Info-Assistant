...
class OpenAI(LanguageModels):
    def __init__(self):
        ...
        self.client = AzureOpenAI(azure_endpoint=azure_openai_service,
                                  api_key=azure_openai_key,
                                  api_version="2024-05-01-preview")

        self.azure_openai_chatgpt_deployment = os.environ['AZURE_OPENAI_CHATGPT_DEPLOYMENT']
        self.azure_openai_embeddings_deployment = os.environ['AZURE_OPENAI_EMBEDDINGS_DEPLOYMENT']
    ...
    def get_text_embeddings(self, text: str) -> list[float]:
        ...
        logger.info(f"Getting Text Embeddings...")
