...
def prompt_content_generator(video_id, prompt_content):
...
def get_sections_generator(video_id, video_prompt_content, account_details, embedding_cb, embeddings_col_name="content_vector"):
    ''' Returns a generator of sections. '''

    #prompt_content_yield = prompt_content_generator(video_id, video_prompt_content)
    
    for video_id, video_name, partition, section_index, section in prompt_content_generator(video_id, video_prompt_content):
